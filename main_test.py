...
while True:
    ...
    if nouvelle_position_x < 0:
        nouvelle_position_x = nb_colonnes - CASE_SIZE
    elif nouvelle_position_x >= nb_colonnes:
        nouvelle_position_x = 0

    if nouvelle_position_y < 0:
        nouvelle_position_y = nb_lignes - CASE_SIZE
    elif nouvelle_position_y >= nb_lignes:
